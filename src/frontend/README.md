...
React 18 + TypeScript + Ant Design 5 UI for the student manager. Production builds land in `build/` and Maven copies them into the Spring Boot JAR (`target/classes/static`).

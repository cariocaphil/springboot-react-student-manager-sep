...
Spring Boot + React student manager: Java 17 / Spring Boot 3.4.5 API, CRA React 17 UI bundled into one JAR/container, CI/CD to Docker Hub + AWS Elastic Beanstalk.

...
- Frontend: React 18 + TypeScript, Vite 5, Ant Design 4, TanStack Query 5, React Hook Form 7, Zod, ESLint 9, Prettier; `apiRoutes` + typed `client` (`unfetch`); layout/students component split

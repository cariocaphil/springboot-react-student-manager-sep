...
Spring Boot + React student manager: Java 17 / Spring Boot 2.7.18 API, CRA React 17 UI bundled into one JAR/container, CI/CD to Docker Hub + AWS Elastic Beanstalk.
...
- Backend: Java 17, Spring Boot 2.7.x, `javax.*` (until Boot 3), JPA entity exposed as API

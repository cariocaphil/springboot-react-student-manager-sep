...
**Modernization:** PR 29 upgrades Ant Design to 5.x (React 18 unchanged). Future work continues from PR 29.

| | |
| --- | --- |
| Current | **Java 17** / Spring Boot **3.4.5**; Vite + TypeScript **React 18.3** with **Ant Design 5**, **TanStack Query**, **React Hook Form**, **Zod**, config-driven drawer fields, **ESLint** + **Prettier**; POST **201** / DELETE **204** |
| Next | React 19, or further platform work per roadmap |
...
| Frontend | React **18.3** + **TypeScript**, **Vite 5**, Ant Design **5.29**, **TanStack Query 5**, **React Hook Form 7**, **Zod**, `unfetch`, Vitest, **ESLint 9**, **Prettier** |
